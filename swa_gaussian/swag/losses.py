...
def bert_loss(model, input, target):
    # print("input shape: {}".format(input.shape))
    # print("labels shape: {}".format(labels.shape))
    # print("--------")
    input = input.to(device)
    target = target.to(device)
    # print(input.isnan().any())
    # print(target.isnan().any())
    # print(input)
    # print(target)
    out_dict = model(input_ids=input, labels=target)
    ...
    # print(loss)
    # print(loss.shape)
    # masked = (input==mask_token)
    # preds = logits[masked]
    # print(preds.shape, target.shapel)
